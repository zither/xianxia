...
// 常量已在 core/constants.js 中定义

// 碎片合成所需数量已在 core/constants.js 中定义

// 装备库已在 core/constants.js 中定义

// 副本配置已在 core/constants.js 中定义

// 食物数据已在 core/constants.js 中定义


// ==================== 游戏状态 ====================

// gameState 已在 core/state.js 中定义
...
function startCultivate() {
    if (gameState.autoBattle || gameState.inDungeon) {
...
function renderFoodShop() {
    const categories = {
        noodles: document.getElementById('food-noodles-list'),
        drinks: document.getElementById('food-drinks-list'),
        special: document.getElementById('food-special-list')
    };
        ...
        foods.forEach(food => {
            ...
            itemEl.innerHTML = `
                <div class="shop-item-info">
                    <span class="shop-item-icon">${food.icon}</span>
                    <span class="shop-item-name">${food.name}</span>
                    <span class="shop-item-stats">饱食+${food.hunger} 体力+${food.energy}</span>
                </div>
                <div>
                    <button class="shop-item-btn" ${canBuy ? '' : 'disabled'} onclick="buyFood('${food.id}')">${food.cost}</button>
                </div>
            `;
